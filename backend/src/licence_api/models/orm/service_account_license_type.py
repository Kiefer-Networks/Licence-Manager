"""Service Account License Type ORM model."""
...
class ServiceAccountLicenseTypeORM(Base, UUIDMixin, TimestampMixin):
    """Service Account License Type database model for marking license types as service accounts."""

    __tablename__ = "service_account_license_types"

    license_type: Mapped[str] = mapped_column(String(500), unique=True, nullable=False)

"""Service Account Pattern ORM model."""
...
class ServiceAccountPatternORM(Base, UUIDMixin, TimestampMixin):
    """Service Account Pattern database model for global service account detection."""

    __tablename__ = "service_account_patterns"
